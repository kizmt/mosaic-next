...
export default function DashboardCard04() {
  ...
  return(
    <div className="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-background-200 shadow-lg rounded-sm border border-slate-200 dark:border-primary-100">
