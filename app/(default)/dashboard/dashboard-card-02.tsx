...
export default function DashboardCard02() {
  ...
  return(
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-background-200 shadow-lg rounded-sm border border-slate-200 dark:border-primary-100">
